    ...
    <div className="container mx-auto mt-8 p-4 bg-gray-100">
      ...
      <div className="mt-8">
        <table className="min-w-full bg-white border border-gray-300 table-fixed">
          <thead>
            <tr>
              <th className="border-b p-2 pl-3">Tên Voucher</th>
              <th className="border-b p-2 pl-3">Mô tả</th>
              <th className="border-b p-2 pl-3">Mã Voucher</th>
              <th className="border-b p-2 pl-3">Giảm giá (%)</th>
              <th className="border-b p-2 pl-3">Số lượng</th>
              <th className="border-b p-2 pl-3">Giá tối đa được giảm</th>
              <th className="border-b p-2 pl-3">Thao tác</th>
            </tr>
          </thead>
          <tbody>
            {listVoucher?.length > 0 &&
              listVoucher.map((voucher, index) => (
                <tr key={index}>
                  <td className="border-b p-2 pl-12">{voucher.nameVoucher}</td>
                  <td className="border-b p-2 pl-12">{voucher.description}</td>
                  <td className="border-b p-2 pl-12">{voucher.codeVoucher}</td>
                  <td className="border-b p-2 pl-12">{voucher.priceSale}%</td>
                  <td className="border-b p-2 pl-12">{voucher.quantity}</td>
                  <td className="border-b p-2 pl-28">
                    {formattedPrice(voucher.maxPriceSale)}
                  </td>
                  <td className="border-b p-2 pl-12">
                    {/* <button
